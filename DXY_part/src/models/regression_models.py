...
class RidgeLassoModel:
    ...
    def __init__(
        ...
        self.model = None
        self.scaler   = StandardScaler()   # scales X
        self.y_scaler = StandardScaler()   # scales y — prevents alpha collapse on small-magnitude targets
    ...
    def load(self, filename: Optional[str] = None) -> 'RidgeLassoModel':
        ...
        self.y_scaler = model_data.get('y_scaler', StandardScaler())
